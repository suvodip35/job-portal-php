        ...
        <div class="flex flex-col md:flex-row gap-6 mb-6">
          ...
          <div class="flex-1">
            ...
            <div class="flex flex-wrap gap-3 mt-6">
              ...
              <a href="<?= e($book['amazon_link']) ?>" target="_blank" rel="nofollow sponsored noopener" 
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-3 italic">
              * Affiliate Disclosure: As an Amazon Associate, FromCampus earns from qualifying purchases. We may earn a commission when you buy through links on our site at no extra cost to you.
            </p>
          </div>
        </div>
