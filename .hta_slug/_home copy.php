...
if ($search) {
    $where[] = "(j.job_title LIKE :search OR j.company_name LIKE :search OR j.description LIKE :search)"; 
    ...
    <div class="sticky top-20 space-y-4">
      ...
      <div class="p-4 border rounded-xl bg-white dark:bg-gray-900 shadow">
        ...
        <ul class="space-y-3">
          ...
          <li class="flex items-start gap-2">
            ...
            <a href="<?= BASE_URL ?>job?slug=<?= e($lu['job_title_slug']) ?>" class="text-sm hover:underline">
              <?= e($lu['job_title']) ?>
      ...
      <div class="p-4 border rounded-xl bg-white dark:bg-gray-900 shadow">
        ...
        <ul class="space-y-2 text-sm">
          <li><a class="hover:underline" href="<?= BASE_URL ?>mock_tests.php">Mock Tests</a></li>
          <li><a class="hover:underline" href="<?= BASE_URL ?>notifications.php">Push Alerts</a></li>
          <li><a class="hover:underline" href="<?= BASE_URL ?>contact.php">Contact</a></li>
        </ul>
      </div>
    </div>
  </aside>
