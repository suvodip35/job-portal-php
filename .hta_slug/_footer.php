    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
      ...
      <div>
        ...
        <div class="flex space-x-4">
          ...
          <a href="#" class="text-gray-600 dark:text-gray-400 hover:text-pink-600 dark:hover:text-pink-400">
          ...
          <a href="#" class="text-gray-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-300">
