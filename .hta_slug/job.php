      ...
      <div class="p-6">
        ...
        <div class="flex flex-wrap items-center gap-3 mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <div class="flex items-center gap-2">
            ...
            <!-- WhatsApp -->
            <a href="https://wa.me/?text=<?= $shareText . ' ' . urlencode($currentUrl) ?>" target="_blank" rel="noopener" class="p-2 bg-green-500 text-white rounded-full hover:bg-green-600 transition" title="Share on WhatsApp">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Telegram -->
             <a href="https://t.me/share/url?url=<?= urlencode($currentUrl) ?>&text=<?= $shareText ?>" target="_blank" rel="noopener" class="p-2 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition" title="Share on Telegram">
